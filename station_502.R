...
df_2018 <- get_ddarung_daily_info_2018(502)
df_2019 <- get_ddarung_daily_info_2019(502)
df_2020 <- get_ddarung_daily_info_2020(502)
df_2021 <- get_ddarung_daily_info_2021(502)
...
df_2022_502 <- df_2022[df_2022$대여소번호==502,]

dim(df_2022_502)

df_full_502 <- rbind(df_2018, df_2019, df_2020, df_2021, df_2022_502)

summary(df_full_502)
dim(df_full_502)
str(df_full_502)
sum(is.na(df_full_502))
...
df_merge3[!complete.cases(df_merge3), ] # 한 줄 결측 (두 줄 결측이었는데 왜 한 줄로 바뀌었을까)
